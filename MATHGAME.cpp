...
stQuestion GenerateQuizzQuestion(enQuestionsLevel QuestionLevel, enOperationType OpType)
{
	stQuestion Question;
...
void GenerateQuizzQuestions(stQuizz& Quizz)
{
	...
	{
		Quizz.QuestionList[Question] = GenerateQuizzQuestion(Quizz.QuestionLevel, Quizz.OpType);
	}
}
